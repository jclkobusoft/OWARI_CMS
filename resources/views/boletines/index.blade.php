        ...
        buttons: [
            {
                ...
                action: function ( e, dt, button, config ) {
                  window.location = '{{ route('boletines.create') }}';
                }   
            },
            {
                extend: 'excelHtml5',
...
@section('contenido')
	 <section id="horizontal">
              ...
              <div class="card">
                ...
                <div class="card-content collapse show">
                  <div class="card-body card-dashboard">
                    <p class="card-text">Agrega, edita y elimina informacion relacionada con los boletines.</p>
         ...
         {{ Form::open(['route' => ['boletines.destroy',':IDENTIFICADOR'],'method' => 'DELETE','id' => 'form-delete']) }}
    {{ form::close() }}
@endsection