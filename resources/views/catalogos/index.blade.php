        ...
        buttons: [
            {
                ...
                action: function ( e, dt, button, config ) {
                  window.location = '{{ route('catalogos.create') }}';
                }   
            },
            {
                extend: 'excelHtml5',
    ...
    datatable.on('row-reorder', function (e, details) {
            ...
            if(details.length) {
                ...
                $.ajax({
                    ...
                    method: 'POST',
                    url: "{{ route('catalogos.ordenamiento') }}",
                    data: { rows }
...
@section('contenido')
	 <section id="horizontal">
              ...
              <div class="card">
                ...
                <div class="card-content collapse show">
                  <div class="card-body card-dashboard">
                    <p class="card-text">Agrega, edita y elimina informacion relacionada con los catalogos.</p>
         ...
         {{ Form::open(['route' => ['catalogos.destroy',':IDENTIFICADOR'],'method' => 'DELETE','id' => 'form-delete']) }}
    {{ form::close() }}
@endsection