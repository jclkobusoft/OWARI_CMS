      ...
      <div class="col-md-12">
        <div class="card">
          <div class="card-header">
            <h4 class="card-title" id="horz-layout-colored-controls">Editar pagina de notinikko</h4>
            <a class="heading-elements-toggle"><i class="fa fa-ellipsis-v font-medium-3"></i></a>
          </div>
          <div class="card-content collpase show">
            <div class="card-body">
              <div class="card-text">
                <p>Edita y crea elementos para la pagina de notinikko.</p>
              </div>
              {{ Form::model($empresa,['route' => ['empresa.guardar_notinikko',$empresa],'files' => true,'method' => 'put', 'class' => 'form form-horizontal']) }}
                <div class="form-body">
                  <div class="row">
                    <div class="col-md-12">
                       <div class="form-group">
                          {{ Form::label('notinikko','Contenido') }}
                          {{ Form::textarea('notinikko',null,['class' => 'form-control summernote']) }}
                        </div> 
                    </div>
                  </div>
                </div>
