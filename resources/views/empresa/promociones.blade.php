      ...
      <div class="col-md-12">
        <div class="card">
          <div class="card-header">
            <h4 class="card-title" id="horz-layout-colored-controls">Editar página de promociones</h4>
            <a class="heading-elements-toggle"><i class="fa fa-ellipsis-v font-medium-3"></i></a>
          </div>
          <div class="card-content collpase show">
            <div class="card-body">
              <div class="card-text">
                <p>Edita y crea elementos para la página de promociones.</p>
              </div>
              {{ Form::model($empresa,['route' => ['empresa.guardar_promociones',$empresa],'files' => true,'method' => 'put', 'class' => 'form form-horizontal']) }}
                <div class="form-body">
                  <div class="row">
                    <div class="col-md-12">
                       <div class="form-group">
                          {{ Form::label('promociones','Contenido') }}
                          {{ Form::textarea('promociones',null,['class' => 'form-control summernote']) }}
                        </div> 
                    </div>
                  </div>
                </div>
