      ...
      <div class="col-md-12">
        <div class="card">
          <div class="card-header">
            <h4 class="card-title" id="horz-layout-colored-controls">Agregar entrada</h4>
          ...
          <div class="card-content collpase show">
            <div class="card-body">
              ...
              <div class="form-body">
               {{ Form::open(['route' => 'informate.store','files' => true,'method' => 'post', 'class' => 'form form-horizontal']) }}
