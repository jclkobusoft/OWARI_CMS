        ...
        buttons: [
            {
                ...
                action: function ( e, dt, button, config ) {
                  window.location = '{{ route('informate.create') }}';
                }   
            }
        ],
        "scrollX": true,
	        ...
	        "ajax": "{{ route('informate.data') }}",
	        columns: [
                { data: 'id', name: 'id' },
                { data: 'titulo', name: 'titulo' },
                { data: 'subtitulo', name: 'subtitulo' },
                { data: 'evento', name: 'evento' },
                { data: 'evento_fecha', name: 'evento_fecha' },
...
@section('contenido')
	 <section id="horizontal">
              ...
              <div class="card">
                ...
                <div class="card-content collapse show">
                  <div class="card-body card-dashboard">
                    <p class="card-text">Agrega, edita y elimina informacion relacionada con las entradas de blog o eventos en el sistema.</p>
         ...
         {{ Form::open(['route' => ['informate.destroy',':IDENTIFICADOR'],'method' => 'DELETE','id' => 'form-delete']) }}
    {{ form::close() }}
@endsection