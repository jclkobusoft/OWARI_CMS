    ...
    $('body').on('click', '.eliminar_registro', function () {
        ...
        buttons: [
            {
                ...
                action: function ( e, dt, button, config ) {
                  window.location = '{{ route('marcas.create') }}';
                }   
            },
            {
                extend: 'excelHtml5',
        ...
        "scrollX": true,
	        ...
	        columns: [
	            ...
	            { data: 'tipo', name: 'tipo' },
                { data: 'redireccion', name: 'redireccion' },
...
@section('contenido')
	 <section id="horizontal">
              ...
              <div class="card">
                ...
                <div class="card-content collapse show">
                  <div class="card-body card-dashboard">
                    <p class="card-text">Agrega, edita y elimina información relacionada con las marcas registradas en el sistema.</p>
         ...
         {{ Form::open(['route' => ['marcas.destroy',':IDENTIFICADOR'],'method' => 'DELETE','id' => 'form-delete']) }}
    {{ form::close() }}
@endsection