      ...
      <div class="col-md-12">
        <div class="card">
          <div class="card-header">
            <h4 class="card-title" id="horz-layout-colored-controls">Agregar socio comercial</h4>
          ...
          <div class="card-content collpase show">
            <div class="card-body">
              ...
              <div class="form-body">
               {{ Form::open(['route' => 'socios.store','files' => true,'method' => 'post', 'class' => 'form form-horizontal']) }}
