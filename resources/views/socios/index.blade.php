        ...
        buttons: [
            {
                ...
                action: function ( e, dt, button, config ) {
                  window.location = '{{ route('socios.create') }}';
                }   
            }
        ],
        "scrollX": true,
...
@section('contenido')
	 <section id="horizontal">
              ...
              <div class="card">
                ...
                <div class="card-content collapse show">
                  <div class="card-body card-dashboard">
                    <p class="card-text">Agrega, edita y elimina informacion relacionada con los socios comerciales en el sistema.</p>
         ...
         {{ Form::open(['route' => ['socios.destroy',':IDENTIFICADOR'],'method' => 'DELETE','id' => 'form-delete']) }}
    {{ form::close() }}
@endsection