...
@section('contenido')
          ...
          <div class="card">
            ...
            <div class="card-content collapse show">
              <div class="card-body card-dashboard">
                <p class="card-text">Agrega, edita y elimina información relacionada con los usuarios registrados en el sistema.</p>
     ...
     {{ Form::open(['route' => ['usuarios.destroy',':IDENTIFICADOR'],'method' => 'DELETE','id' => 'form-delete']) }}
    {{ form::close() }}
@endsection