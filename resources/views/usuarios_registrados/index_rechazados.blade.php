  ...
  <script type="text/javascript">
    ...
    $('.scroll-horizontal').DataTable( {
        ...
        "language": {
          ...
          "ajax": "{{ route('usuarios_registrados.data_rechazados') }}",
          columns: [
              { data: 'id', name: 'id' },
...
@section('contenido')
   <section id="horizontal">
          ...
          <div class="card">
            ...
            <div class="card-content collapse show">
              <div class="card-body card-dashboard">
                <p class="card-text">Agrega, edita y elimina informacion relacionada con los usuarios registrados en el sistema.</p>
                <table style="min-width: 100%;vertical-align: center;" class="table display table-striped table-bordered scroll-horizontal">
                  <thead>
                    <tr>
                      <th>ID</th>
                      <th>Clave</th>
     ...
     {{ Form::open(['route' => ['usuarios_registrados.eliminar',':IDENTIFICADOR'],'method' => 'DELETE','id' => 'form-delete']) }}
    {{ form::close() }}
@endsection